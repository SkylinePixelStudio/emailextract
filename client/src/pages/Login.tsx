    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-gray-100">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">LeadMiner Pro</h1>
        ...
        <div className="card">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@leadminer.local"
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
            <p><strong>Default:</strong> admin@leadminer.local / admin123</p>
          </div>
        </div>
      </div
